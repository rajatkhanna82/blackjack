...
(function() {
  ...
  window.AppView = (function(_super) {
    ...
    AppView.prototype.template = _.template('<button class="hit-button">Hit</button> <button class="stand-button">Stand</button><button class="reload-button">Reload</button> <div class="dealer-hand-container"></div> <div class="player-hand-container"></div>');
    ...
    AppView.prototype.initialize = function() {
      this.render();
      return this.model.on("all", this.eventHandler, this);
    };
    ...
    AppView.prototype.eventHandler = function(event) {
      switch (event) {
        case "playerWins":
          alert("Player wins!");
          break;
